...
INSERT INTO skills (name, proficiency, icon, created_at, updated_at, is_frontend) VALUES ('Jenkins', 3, 'jenkins-icon.png', CURRENT_TIMESTAMP(0), CURRENT_TIMESTAMP(0), false);
