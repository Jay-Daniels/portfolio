...
INSERT INTO skills (name, proficiency, icon, created_at, updated_at, is_frontend) VALUES ('React', 2, 'react-icon.png', CURRENT_TIMESTAMP(0), CURRENT_TIMESTAMP(0), true);
...
INSERT INTO skills (name, proficiency, icon, created_at, updated_at, is_frontend) VALUES ('Tailwind CSS', 2, 'tailwind-icon.png', CURRENT_TIMESTAMP(0), CURRENT_TIMESTAMP(0), true);
...
INSERT INTO profile (name, description, picture) VALUES ('Jay Daniels', 'Lorem Ipsum. Neque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit.... Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean efficitur quis dui nec venenatis. Donec tempor malesuada lacus, molestie ullamcorper velit mollis non.', '/components/profile/profile.png');